...
### Cigarette
AGOG.stats %<>% 
  add.header.row("Cigarette usage status, n (%)") %>%
...
### Cannabis
AGOG.stats %<>% add.casecontrol.n.perc("Cannabis","Cannabis usage (ever), n (%)",1)
...
### Allergies
AGOG.stats %<>% add.casecontrol.n.perc("Allergies","Allergies, n (%)","Yes")

### Migraines
AGOG.stats %<>% add.casecontrol.n.perc("Migraines","Migraines, n (%)","Yes")

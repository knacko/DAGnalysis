...
numerics <- c("Age")
booleans <- c("Gender","Hypertension","HighColesterol","DiabetesType1","DiabetesType2","Epilepsy","Seizures","FebrileSeizures","HeadTrauma","Concussions","Amnesia","Shingles","Depression","Rheumatoid","Bipolar","ChickenPox", "Meningitis", "Shingles","Neurofibro","ColdSores")
...
if (any(is.na(AGOG.formatted))) {
  ...
  AGOG.dataset <- list(AGOG.formatted)
}
